  ...
  switch (type) {
    case 'isvObfuscator':
      ...
      case 'followShop':
        ...
        admJson = {"actId": "897353f1fe1a4958a48_220117", "missionType": "collectShop"}
        body = taskPostUrl("/openCardNew/followShop", admJson);
        break;
      case 'addCart':
        url = `${domain}/dm/front/openCardNew/addCart?mix_nick=${$.MixNick || $.MixNicks || ""}`;
        admJson = {"actId": "897353f1fe1a4958a48_220117", "missionType": "addCart"}
      ...
      case 'missionInviteList':
        ...
        admJson = {"inviteListRequest":{"actId":"897353f1fe1a4958a48_220117","userId":10299171,"missionType":"shareAct","inviteType": 1,"buyerNick":($.MixNick || '')}}
