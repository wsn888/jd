...
[task_local]
#京喜签到
20 1,5 * * * jx_sign.js, tag=京喜签到, enabled=true
================Loon==============
[Script]
cron "20 1,5 * * *" jx_sign.js,tag=京喜签到
===============Surge=================
京喜签到 = type=cron,cronexp="20 1,5 * * *",wake-system=1,timeout=3600,jx_sign.js
============小火箭=========
京喜签到 = type=cron,jx_sign.js, cronexpr="20 1,5 * * *", timeout=3600, enable=true
 */
