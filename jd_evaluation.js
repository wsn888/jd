...
================Loon==============
[Script]
cron "37 15 * * *" jd_evaluation.js,tag=京东评价

===============Surge=================
京东评价 = type=cron,cronexp="37 15 * * *",wake-system=1,timeout=3600,jd_evaluation.js

============小火箭=========
京东评价 = type=cron,jd_evaluation.js, cronexpr="37 15 * * *", timeout=3600, enable=true
 */
const $ = new Env('京东评价');
