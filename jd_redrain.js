...
[task_local]
#整点京豆雨
0 * * * * jd_redrain.js, tag=整点京豆雨, enabled=true
==============Loon==============
[Script]
cron "0 * * * *" jd_redrain.js,tag=整点京豆雨
================Surge===============
整点京豆雨 = type=cron,cronexp="0 * * * *",wake-system=1,timeout=3600,jd_redrain.js
===============小火箭==========
整点京豆雨 = type=cron,jd_redrain.js, cronexpr="0 * * * *", timeout=3600, enable=true
*/
const $ = new Env('整点京豆雨');
