...
13 12 17-31 5 * jd_opencard32.js
*/

if (process.env.DY_OPENALL != "true") {
    console.log('\n开卡任务默认不运行,设置变量export DY_OPENALL="true"来运行，无水就停吧\n')
    return
}

const $ = new Env('一见倾芯 天长地久-开卡')
...
!(async () => {
  ...
  $.shareUuid = "24df872fc2834fe7964eadca45155904"
  console.log(`入口:\nhttps://lzdz1-isv.isvjcloud.com/dingzhi/customized/common/activity?activityId=${$.activityId}&shareUuid=${$.shareUuid}`)
  let shareUuidArr = ['24df872fc2834fe7964eadca45155904']
  let n = 0
