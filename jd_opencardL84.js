...
————————————————
入口：[ 2.28-3.8 大牌会员日 (https://lzdz1-isv.isvjcloud.com/dingzhi/bigname/memberday/activity?activityId=dz3eb0e16893aa4f7a91d103a6db0b&shareUuid=668a8f8881e9475a8423e1fca9ecc2cd)]
...
!(async () => {
  ...
  authorCodeList = await getAuthorCodeList('https://gitee.com/KingRan521/JD-Scripts/raw/master/shareCodes/opencard84.json')
    if(authorCodeList === '404: Not Found'){
        authorCodeList = [
            '668a8f8881e9475a8423e1fca9ecc2cd'
        ]
    }
