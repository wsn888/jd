...
[task_local]
#京东极速版
21 3,8 * * * jd_speed_sign.js, tag=京东极速版, enabled=true

================Loon==============
[Script]
cron "21 3,8 * * *" jd_speed_sign.js,tag=京东极速版

===============Surge=================
京东极速版 = type=cron,cronexp="21 3,8 * * *",wake-system=1,timeout=33600, jd_speed_sign.js

============小火箭=========
京东极速版 = type=cron, jd_speed_sign.js, cronexpr="21 3,8 * * *", timeout=33600, enable=true
*/
const $ = new Env('京东极速版');
