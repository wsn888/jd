...
[task_local]
#jd免费水果
5 6-18/6 * * * jd_fruit.js, tag=东东农场, enabled=true
=========================Loon=============================
[Script]
cron "5 6-18/6 * * *" jd_fruit.js,tag=东东农场

=========================Surge============================
东东农场 = type=cron,cronexp="5 6-18/6 * * *",wake-system=1,timeout=3600,jd_fruit.js

=========================小火箭===========================
东东农场 = type=cron,jd_fruit.js, cronexpr="5 6-18/6 * * *", timeout=3600, enable=true
