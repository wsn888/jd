...
[task_local]
#个护女神节
35 10 * * * jd_opencardL85.js, tag=个护女神节, enabled=true

================Loon==============
[Script]
cron "35 10 * * *" jd_opencardL85.js,tag=个护女神节

===============Surge=================
个护女神节 = type=cron,cronexp="35 10 * * *",wake-system=1,timeout=3600,jd_opencardL85.js

============小火箭=========
个护女神节 = type=cron,jd_opencardL85.js, cronexpr="35 10 * * *", timeout=3600, enable=true
