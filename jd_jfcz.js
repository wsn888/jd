...
[task_local]
#见缝插针
15 10 * * * jd_jfcz.js, tag=见缝插针, enabled=true
=================================Loon===================================
[Script]
cron "15 10 * * *" jd_jfcz.js,tag=见缝插针
===================================Surge================================
见缝插针 = type=cron,cronexp="15 10 * * *",wake-system=1,timeout=3600,jd_jfcz.js
====================================小火箭=============================
见缝插针 = type=cron,jd_jfcz.js, cronexpr="15 10 * * *", timeout=3600, enable=true
 */
