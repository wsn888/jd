...
[task_local]
#JoyJd任务脚本
5 2,18 * * * jd_joyjd_open.js, tag=JoyJd任务脚本, enabled=true

================Loon==============
[Script]
cron "5 2,18 * * *" jd_joyjd_open.js,tag=JoyJd任务脚本

===============Surge=================
JoyJd任务脚本 = type=cron,cronexp="5 2,18 * * *",wake-system=1,timeout=3600,jd_joyjd_open.js

============小火箭=========
JoyJd任务脚本 = type=cron,jd_joyjd_open.js, cronexpr="5 2,18 * * *", timeout=3600, enable=true
*/
