...
[task_local]
#京喜牧场
20 0-23/2 * * * jd_jxmc.js, tag=京喜牧场, enabled=true

================Loon==============
[Script]
cron "20 0-23/2 * * *" jd_jxmc.js,tag=京喜牧场

===============Surge=================
京喜牧场 = type=cron,cronexp="20 0-23/2 * * *",wake-system=1,timeout=3600,jd_jxmc.js

============小火箭=========
京喜牧场 = type=cron,jd_jxmc.js, cronexpr="20 0-23/2 * * *", timeout=3600, enable=true
 */
