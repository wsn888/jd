...
[task_local]
#东东乐园
30 7 * * * jd_ddnc_farmpark.js, tag=东东乐园, enabled=true

================Loon==============
[Script]
cron "30 7 * * *" jd_ddnc_farmpark.js tag=东东乐园

===============Surge=================
东东乐园 = type=cron,cronexp="30 7 * * *",wake-system=1,timeout=3600,jd_ddnc_farmpark.js

============小火箭=========
东东乐园 = type=cron,jd_ddnc_farmpark.js, cronexpr="30 7 * * *", timeout=3600, enable=true
