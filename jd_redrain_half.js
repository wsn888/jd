...
[task_local]
#半点京豆雨
31 20-23/1 * * * jd_redrain_half.js, tag=半点京豆雨, enabled=true
==============Loon==============
[Script]
cron "31 20-23/1 * * *" jd_redrain_half.js,tag=半点京豆雨
================Surge===============
半点京豆雨 = type=cron,cronexp="31 20-23/1 * * *",wake-system=1,timeout=3600,jd_redrain_half.js
===============小火箭==========
半点京豆雨 = type=cron,jd_redrain_half.js, cronexpr="31 20-23/1 * * *", timeout=3600, enable=true
*/
const $ = new Env('半点京豆雨');
let allMessage = '', id = '';
