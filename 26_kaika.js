/*
入口复制到jd：
https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity/2227668?activityId=ae2674803c574c26af90243148a98312&shareUuid=486594db5fbf43f0a958d44659016451
============Quantumultx===============
[task_local]
#9.8-9.30 京粮食品送福利
5 0,5,23 * * * jd_opencard_Long_long_9_8-9-30.js, tag=9.8-9.30 京粮食品送福利, 

================Loon==============
[Script]
cron "5 0,5,23 * * *" script-path=jd_opencard_Long_long_9_8-9-30.js,tag=9.8-9.30 京粮食品送福利

===============Surge=================
9.8-9.30 京粮食品送福利 = type=cron,cronexp="5 0,5,23 * * *",wake-system=1,timeout=3600,script-path=jd_opencard_Long_long_9_8-9-30.js

============小火箭=========
9.8-9.30 京粮食品送福利 = type=cron,script-path=jd_opencard_Long_long_9_8-9-30.js, cronexpr="5 0,5,23 * * *", timeout=3600, enable=true
*/
...
function followShop() {
    return new Promise(resolve => {
        let body = `activityId=ae2674803c574c26af90243148a98312&pin=${encodeURIComponent($.myPingData.secretPin)}&actorUuid=${$.actorUuid}&taskType=23&taskValue=1000091863&shareUuid=${$.shareUuid ? $.shareUuid : '486594db5fbf43f0a958d44659016451'}`
...
function getDrawRecordHasCoupon() {
    return new Promise(resolve => {
        let body = `activityId=ae2674803c574c26af90243148a98312&actorUuid=${$.actorUuid}&shareUuid=${$.shareUuid ? $.shareUuid : '486594db5fbf43f0a958d44659016451'}&pin=${encodeURIComponent($.myPingData.secretPin)}`
...
function saveTask() {
    return new Promise(resolve => {
        let body = `activityId=ae2674803c574c26af90243148a98312&pin=${encodeURIComponent($.myPingData.secretPin)}&taskType=2&taskValue=2736969&actorUuid=${$.actorUuid}&shareUuid=${$.shareUuid ? $.shareUuid : '486594db5fbf43f0a958d44659016451'}`
...
async function startDraw(type) {
    return new Promise(resolve => {
        let body = `activityId=ae2674803c574c26af90243148a98312&actorUuid=${$.actorUuid}&shareUuid=${$.shareUuid ? $.shareUuid : '486594db5fbf43f0a958d44659016451'}&pin=${encodeURIComponent($.myPingData.secretPin)}&type=${type}`
        $.post(taskPostUrl('/dingzhi/dz/openCard/startDraw', body, `https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity/2736969?activityId=ae2674803c574c26af90243148a98312&shareUuid=${$.shareUuid ? $.shareUuid : '486594db5fbf43f0a958d44659016451'}`), async (err, resp, data) => {
            try {
                if (err) {
                    console.log(`${$.name} API请求失败，请检查网路重试`)
                } else {
...
function getHtml() {
    return new Promise(resolve => {
        $.get({
            url: `https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity/2227668?activityId=ae2674803c574c26af90243148a98312&shareUuid=${$.shareUuid ? $.shareUuid : '486594db5fbf43f0a958d44659016451'}&adsource=null&shareuserid4minipg=Mg1nuWzSqcg9M7B5iXIAOU7oeVP9kq2pYSH90mYt4m3fwcJlClpxrfmVYaGKuquQkdK3rLBQpEQH9V4tdrrh0w%3D%3D&shopid=10000091863&lng=108.109014&lat=34.245032&sid=9e78de7ecd219bd52ad2038c1a061e1w&un_area=27_2402_44514_56717`,
            headers: {
...
function adLog() {
    return new Promise(resolve => {
        $.post({
            ...
            body: `venderId=1000091863&code=99&pin=${encodeURIComponent($.myPingData.secretPin)}&activityId=ae2674803c574c26af90243148a98312&pageUrl=https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity/2227668?activityId=ae2674803c574c26af90243148a98312&shareUuid=${$.shareUuid ? $.shareUuid : '86260549c0de43bb9d3c879daf6bfbe2'}&adsource=null&shareuserid4minipg=Mg1nuWzSqcg9M7B5iXIAOU7oeVP9kq2pYSH90mYt4m3fwcJlClpxrfmVYaGKuquQkdK3rLBQpEQH9V4tdrrh0w%3D%3D&shopid=1000091863&lng=108.109014&lat=34.245032&sid=9e78de7ecd219bd52ad2038c1a061e1w&un_area=27_2402_44514_56717`,
            headers: {
                'User-Agent': `Mozilla/5.0 (Linux; U; Android 8.0.0; zh-cn; Mi Note 2 Build/OPR1.170623.032) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/61.0.3163.128 Mobile Safari/537.36 XiaoMi/MiuiBrowser/10.1.1`,
                'Host': 'lzdz1-isv.isvjcloud.com',
...
function checkOpenCard() {
    return new Promise(resolve => {
        let body = `activityId=ae2674803c574c26af90243148a98312&actorUuid=${$.actorUuid}&shareUuid=${$.shareUuid}&pin=${encodeURIComponent($.myPingData.secretPin)}`
...
function taskPostUrl(url, body, referer) {
    return {
        ...
        headers: {
            ...
            "Referer": referer ? referer : `https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity/2227668?activityId=ae2674803c574c26af90243148a98312&shareUuid=${$.shareUuid ? $.shareUuid : '486594db5fbf43f0a958d44659016451'}&adsource=&shareuserid4minipg=Mg1nuWzSqcg9M7B5iXIAOU7oeVP9kq2pYSH90mYt4m3fwcJlClpxrfmVYaGKuquQkdK3rLBQpEQH9V4tdrrh0w%3D%3D&shopid=1000091863&lng=108.109014&lat=34.245032&sid=9e78de7ecd219bd52ad2038c1a061e1w&un_area=27_2402_44514_56717`,
            "User-Agent": UA,
