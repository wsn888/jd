...
[task_local]
#京东保价
55 12 * * * jd_price.js, tag=京东保价, enabled=true

================Loon==============
[Script]
cron "55 12 * * *" jd_price.js,tag=京东保价

===============Surge=================
京东保价 = type=cron,cronexp="55 12 * * *",wake-system=1,timeout=3600,jd_price.js

============小火箭=========
京东保价 = type=cron,jd_price.js, cronexpr="55 12 * * *", timeout=3600, enable=true
 */
const $ = new Env('京东价保');
