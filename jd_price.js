...
[task_local]
#京东保价
39 20 * * * jd_price.js, tag=京东保价, enabled=true

================Loon==============
[Script]
cron "39 20 * * *" jd_price.js,tag=京东保价

===============Surge=================
京东保价 = type=cron,cronexp="39 20 * * *",wake-system=1,timeout=3600,jd_price.js

============小火箭=========
京东保价 = type=cron,jd_price.js, cronexpr="39 20 * * *", timeout=3600, enable=true
 */
const $ = new Env('京东保价');
