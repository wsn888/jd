...
[task_local]
#京喜财富岛
1 0-23/2 * * * jd_cfd.js, tag=京喜财富岛, enabled=true

================Loon==============
[Script]
cron "1 0-23/2 * * *" jd_cfd.js,tag=京喜财富岛

===============Surge=================
京喜财富岛 = type=cron,cronexp="1 0-23/2 * * *",wake-system=1,timeout=3600,jd_cfd.js

============小火箭=========
京喜财富岛 = type=cron,jd_cfd.js, cronexpr="1 0-23/2 * * *", timeout=3600, enable=true
 */
