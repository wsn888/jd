...
入口复制到jd：
https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity/2227668?activityId=ae2674803c574c26af90243148a98312&shareUuid=86260549c0de43bb9d3c879daf6bfbe2
...
function followShop() {
    return new Promise(resolve => {
        let body = `activityId=ae2674803c574c26af90243148a98312&pin=${encodeURIComponent($.myPingData.secretPin)}&actorUuid=${$.actorUuid}&taskType=23&taskValue=1000091863&shareUuid=${$.shareUuid ? $.shareUuid : '86260549c0de43bb9d3c879daf6bfbe2'}`
...
function getDrawRecordHasCoupon() {
    return new Promise(resolve => {
        let body = `activityId=ae2674803c574c26af90243148a98312&actorUuid=${$.actorUuid}&shareUuid=${$.shareUuid ? $.shareUuid : '86260549c0de43bb9d3c879daf6bfbe2'}&pin=${encodeURIComponent($.myPingData.secretPin)}`
...
function saveTask() {
    return new Promise(resolve => {
        let body = `activityId=ae2674803c574c26af90243148a98312&pin=${encodeURIComponent($.myPingData.secretPin)}&taskType=2&taskValue=2736969&actorUuid=${$.actorUuid}&shareUuid=${$.shareUuid ? $.shareUuid : '86260549c0de43bb9d3c879daf6bfbe2'}`
...
async function startDraw(type) {
    return new Promise(resolve => {
        let body = `activityId=ae2674803c574c26af90243148a98312&actorUuid=${$.actorUuid}&shareUuid=${$.shareUuid ? $.shareUuid : '86260549c0de43bb9d3c879daf6bfbe2'}&pin=${encodeURIComponent($.myPingData.secretPin)}&type=${type}`
        $.post(taskPostUrl('/dingzhi/dz/openCard/startDraw', body, `https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity/2736969?activityId=ae2674803c574c26af90243148a98312&shareUuid=${$.shareUuid ? $.shareUuid : '86260549c0de43bb9d3c879daf6bfbe2'}`), async (err, resp, data) => {
            try {
                if (err) {
                    console.log(`${$.name} API请求失败，请检查网路重试`)
                } else {
...
function taskPostUrl(url, body, referer) {
    return {
        ...
        headers: {
            ...
            "Referer": referer ? referer : `https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity/2227668?activityId=ae2674803c574c26af90243148a98312&shareUuid=${$.shareUuid ? $.shareUuid : '86260549c0de43bb9d3c879daf6bfbe2'}&adsource=&shareuserid4minipg=Mg1nuWzSqcg9M7B5iXIAOU7oeVP9kq2pYSH90mYt4m3fwcJlClpxrfmVYaGKuquQkdK3rLBQpEQH9V4tdrrh0w%3D%3D&shopid=1000091863&lng=108.109014&lat=34.245032&sid=9e78de7ecd219bd52ad2038c1a061e1w&un_area=27_2402_44514_56717`,
            "User-Agent": UA,
